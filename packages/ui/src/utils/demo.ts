...
// function generateFakeRow(index: number) {
//     return {
//         id: index,
...
export const dataSource = (length: number = 100) => {
  return source.slice(0, length);
};

export const nestedDataSource = (length: number = 100) => {
  return nestedSource.slice(0, length);
};