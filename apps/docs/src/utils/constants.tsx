...
export const FORM_PROPS = [
  ...
  {
    name: 'errorText',
    description: <>An array of string of status text. This one go along with attribute <code>status</code></>,
    reflects: false,
    type: 'Array<string>',
  },
  {
    name: 'status',
    description: <>Use to show status & corresponding <code>errorText</code></>,
    reflects: false,
...
function getStorybookBaseUrl() {
  if (typeof window !== 'undefined') {
    ...
    if (hostname.includes('studs.strongtie.com')) {
      ...
      return 'http://localhost:6002/?path=/docs';
    }
  }
