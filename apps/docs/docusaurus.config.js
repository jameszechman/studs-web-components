    ...
    [
      ...
      ({
        docs: {
          ...
          exclude: [
            '**/components/alert-banner.mdx',
            '**/components/alert-dialog.mdx',
            '**/components/alert-dialog-group.mdx',
            '**/components/app-shell.mdx',
            '**/components/avatar.mdx',
            '**/components/avatar-group.mdx',
            '**/components/badge.mdx',
            '**/components/breadcrumbs.mdx',
            '**/components/button-group.mdx',
            '**/components/carousel.mdx',
            '**/components/checkbox-group.mdx',
            '**/components/chip.mdx',
            '**/components/collapse.mdx',
            '**/components/date-picker.mdx',
            '**/components/divider.mdx',
            '**/components/drawer.mdx',
            '**/components/dropdown.mdx',
            '**/components/file-upload.mdx',
            '**/components/footer.mdx',
            '**/components/form.mdx',
            '**/components/global-banner.mdx',
            ...
            '**/components/resizer.mdx',
            '**/components/slider.mdx',
            '**/components/stepper.mdx',
            '**/components/switch.mdx',
            '**/components/text-area.mdx',
            '**/components/toggle-button-group.mdx',
  ...
  plugins: ['docusaurus-plugin-sass',
    [
      ...
      /** @type {import('docusaurus-plugin-react-docgen-typescript').Options} */
      {
        ...
        src: [
          // './src/components/**/*.tsx',
          // './node_modules/@studs/react/src/**/*.tsx',
          './src/components/StudsComponentDocs/**/*.tsx',
        ],
        global: true,
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Storybook',
                href: `https://studs.strongtie.com/storybook`,
              },
            ],
          },
        ],
